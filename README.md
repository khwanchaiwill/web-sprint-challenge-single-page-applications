...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    Answer: The useRouterMatch is hook attempts to match the current URL.

1. How would you explain form validation to someone who has never programmed before?

    Answer: Form validation in react allows an error message to display if the user has not correct filled form witht he expect type of input

1. In 1-2 sentences, define end to end testing.

    Answer: Is a technique used to test whether the flow of an application right from start to finish is behaving as expected. 
